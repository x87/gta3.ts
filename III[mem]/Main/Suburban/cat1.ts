...
async function mission_start_cat1() {
...

    {
        ...
        $.colubian_guard1 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -395.4, 293.4, -100.0) //Near Cat
        $.colubian_guard1.giveWeapon(3 /* WEAPONTYPE_UZI */, 200)
        //ADD_ARMOUR_TO_CHAR colubian_guard1 100

        $.colubian_guard3 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -368.1, 252.4, -100.0) //Guarding gate (west)
        $.colubian_guard3.giveWeapon(3 /* WEAPONTYPE_UZI */, 200)
        $.colubian_guard3.setHeading(0.0)

        $.colubian_guard4 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -358.0, 251.8, -100.0) //Guarding gate	(east)
        $.colubian_guard4.giveWeapon(3 /* WEAPONTYPE_UZI */, 200)
        $.colubian_guard4.setHeading(0.0)

        $.colubian_guard12 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -392.4, 301.0, 70.7) //On masion balcony (west)
        ...
        $.colubian_guard13 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -374.0, 301.0, 70.7) //On masion balcony (east)
        ...
        $.colubian_guard2 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -380.1, 282.6, -100.0) //Dead guard
        ...
        $.colubian_guard14 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -955.5, 309.7, -100.0) //guards by 1st columbian block
        ...
        $.colubian_guard15 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -943.0, 311.0, -100.0) //guards by 1st columbian block
  ...
  */
        ...
        $.colubian_guard5 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1037.2, 467.9, -100.0) //guards by 2nd columbian block
        ...
        $.colubian_guard6 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1035.0, 454.8, -100.0) //guards by 2nd columbian block
        ...
        $.colubian_guard7 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1087.8, 472.0, -100.0) //Fist guard on tower
        ...
        $.colubian_guard8 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1142.3, 445.3, -100.0) //Fist guard on second tower
        ...
        $.colubian_guard16 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1065.3, 453.8, -100.0) //guards by 2nd columbian block
        ...
        $.colubian_guard17 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1066.3, 475.8, -100.0) //guards by 2nd columbian block
        ...
        $.colubian_guard18 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1104.9, 440.1, -100.0) //On boxes
        ...
        $.colubian_guard19 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1125.4, 448.8, -100.0) //On boxes
        ...
        $.colubian_guard22 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1159.5, 424.2, -100.0) //By boxes
        ...
        $.colubian_guard23 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1170.0, 379.9, -100.0) //ground near heli pad
        ...
        $.colubian_guard24 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1171.7, 384.8, -100.0) //ground near heli pad
        ...
        $.colubian_guard26 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1156.8, 407.5, -100.0) //ground near heli pad
        ...
        $.colubian_guard9 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1183.0, 370.9, -100.0) //Below Heli Pad with flame thrower
        ...
        $.colubian_guard10 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_B`, -1204.9, 343.0, -100.0) //On heli pad with flame thrower
        ...
        $.colubian_guard20 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1188.5, 368.0, -100.0) //On heli pad with M16
        ...
        $.colubian_guard21 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1176.3, 357.1, -100.0) //On heli pad with AK47
        ...
        $.colubian_guard25 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, -1199.4, 334.1, -100.0) //On heli pad with AK47
