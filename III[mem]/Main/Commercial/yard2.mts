...
class mission_yd2_failed_assert extends Error {
    constructor() {
        super(MISSION_YD2_FAILED_ASSERT);
...
async function onFailed(error?: unknown) {
    const assert = error instanceof mission_yd2_failed_assert;
    ...
    mission_yd2_failed_assert: Text.PrintBig('M_FAIL', 2000, 1);
}
