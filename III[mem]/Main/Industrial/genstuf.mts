...
(async () => {
    ...
    tramp_tunnel(); // START_NEW_SCRIPT tramp_tunnel
    ind_sound(); // START_NEW_SCRIPT ind_sound
    com_ammu(); // START_NEW_SCRIPT com_ammu
    com_car_park(); // START_NEW_SCRIPT com_car_park
    dog_sound(); // START_NEW_SCRIPT dog_sound
    run_gated('_flag_cobblers_complete', cobblers); // START_NEW_SCRIPT cobblers
