...
async function body() {
    ...
    before_mission_jump4: {
        before_mission_jump2: {
            mission_check: {
                ...
                if ($.player.locateStoppedInCar2D(906.0, -425.0, 4.0, 4.0, false) && $.player.isInCar($.mission_taxi_fm2)) {
                    ...
                    break before_mission_jump2; // SCM GOTO → mission_jump2
                }
            }
            ...
            Hud.DisplayCounterWithString($.$id.spooked_counter, 1, 'FM2_16');
            TIMERB = 0;
            ...
            if ($.flag_taxi2_exit_car_fm2 == 1) {
                ...
                break before_mission_jump4; // SCM GOTO → mission_jump4
            }
        }
    ...
    return; // SCM GOTO → mission_frankie2_passed
}
