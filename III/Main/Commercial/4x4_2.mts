    ...
    */
    ...
    while ($.counter_4x4_pickups < 12) {
        ...
        if ($.flag_intro == 0) {
            ...
            Camera.PointAtPoint($.x_8, $.y_8, $.z_8, JUMP_CUT);
        ...
        if ($.intro_time_lapsed > 3500 && $.flag_intro == 1) {
            Camera.PointAtPoint($.x_9, $.y_9, $.z_9, INTERPOLATION);
            $.flag_intro = 2;
        }
        ...
        if ($.intro_time_lapsed > 7000 && $.flag_intro == 3) {
            Camera.PointAtPoint($.x_10, $.y_10, $.z_10, INTERPOLATION);
            $.flag_intro = 4;
        }
        ...
        if (!$.player.isInModel(CAR_LANDSTALKER)) {
