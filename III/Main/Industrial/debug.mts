...
(async () => {
    ...
    let text_z = 0;
    let text_h = 0;
    let player_heading_debug = 0;
    let debug_car_heading = 0;
    let magic_car = new Car(0);
    let button_press_flag = 0;
    let car_colour = 0;
    let car_colour2 = 0;
    let intro_explosion_flag = 0;
    let flag_create_car = 0;
    let initial_create_car = 0;
    let initial_car_selected = 0;
    let counter_create_car = 0;
    let colour_counter = 0;
    let cheat_mode_on_flag = 0;
    let cheat_mode_on = 0;
    let button_pressed_warp = 0;
    let button_pressed_ind = 0;
    let button_pressed_com = 0;
    let button_pressed_sub = 0;
    let repeat_button_press = 0;
    let slow_motion = 0;
    let text_button_pressed = 0;
    let players_car_debug = 0;
    let debug_crap_on = 0;
    let crap_press_flag = 0;
    let no_cars = 0;
    let repeat_butt_press = 0;
    let weather_crap = 0;
    let add_just_the_once_though = 0;
    let invulnerability_on = 0;
