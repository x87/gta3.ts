...
async function mission_start_love4() {
    ...
    $.yard_route3 = 3
    {
        ...
        while (
            !Streaming.HasModelLoaded(car`PANLANT`) ||
            !Streaming.HasModelLoaded(ped`GANG_COLOMBIAN_A`) ||
            !Streaming.HasModelLoaded(car`DODO`) ||
    ...
    async function second_cutscene() {
        ...
        $.colombian_car = Car.Create(131 /* CAR_COLUMB */, 346.8934, -298.46, 15.8)
        $.colombian_car.setHeading(111.7)

        $.goon_at_yard1 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 343.9994, -306.3081, 15.8) // area 1 chatting
        ...
        $.goon_at_yard2 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 341.5678, -306.8592, 15.8) // area 1 chatting
        ...
        $.goon_at_yard3 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 327.7796, -316.6461, 15.9) // by concrete area
        ...
        $.goon_at_yard4 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 335.0769, -338.2184, 15.8) // by pile of wood SW
        ...
        $.goon_at_yard5 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 348.7184, -320.0932, 15.8) // by wooden steps
        ...
        $.goon_at_yard6 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 357.1986, -319.7162, 15.9) // by concrete steps
        ...
        $.goon_at_yard7 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 358.6874, -340.7191, 16.0) // behind last box
        ...
        $.goon_at_yard8 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 360.173, -336.0494, 16.0) // by last box
        ...
        $.goon_at_yard9 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 374.7956, -340.4126, 16.0) // behind lift
        ...
        $.goon_at_yard10 = Char.Create(12 /* PEDTYPE_GANG_COLOMBIAN */, ped`GANG_COLOMBIAN_A`, 391.0353, -298.6616, 17.2) // on building near maze
        ...
        $.yakuza_car2 = Car.Create(129 /* CAR_YAKUZA */, 359.1079, -291.088, 16.0) // out front
        $.yakuza_car3 = Car.Create(129 /* CAR_YAKUZA */, 363.6012, -339.1167, 16.0) // smash fence car
        ...
        $.love_4_blip = Blip.AddForCoord(87.3, -1548.6, 27.255) // LOVES PAD
            ...
            if (!Char.IsDead($.goon_at_yard2)) {
                ...
                if ($.goon_at_yard2_flag == 1) {
                    if ($.game_timer_var > $.goon_at_yard2_duck_timer) {
                        ...
                        $.goon_at_yard2.setObjRunToCoord(333.639, -307.5708)
                        $.goon_at_yard2_flag = 2
                    }
                }
                if ($.goon_at_yard2_flag == 2) {
                    if ($.goon_at_yard2.locateOnFoot2D(333.639, -307.5708, 1.0, 1.0, false)) {
                        $.goon_at_yard2.setObjRunToCoord(333.498, -304.7924)
                        $.goon_at_yard2_flag = 3
                    }
                }
                if ($.goon_at_yard2_flag == 3) {
                    if ($.goon_at_yard2.locateStoppedOnFoot2D(333.498, -304.7924, 1.0, 1.0, false)) {
                        $.goon_at_yard2.setStayInSamePlace(true /* TRUE */)
            ...
            if (!Char.IsDead($.goon_at_yard5)) {
                ...
                if ($.goon_at_yard5_flag == 1) {
                    if ($.goon_at_yard5.locateOnFoot2D(354.6851, -325.3922, 1.0, 1.0, false)) {
                        $.goon_at_yard5.setObjRunToCoord(345.996, -325.4795)
                        $.goon_at_yard5_flag = 2
                    }
                }
                if ($.goon_at_yard5_flag == 2) {
                    if ($.goon_at_yard5.locateOnFoot2D(345.996, -325.4795, 1.0, 1.0, false)) {
        ...
        if ($.c_site_area_flag > 3) {
            if (!Char.IsDead($.goon_at_yard8)) {
                ...
                if ($.goon_at_yard8_flag == 1) {
                    if ($.goon_at_yard8.locateOnFoot2D(375.475, -331.2, 1.0, 1.0, false)) {
                        $.goon_at_yard8.setObjRunToCoord(363.7481, -330.9657) //363.9961 -330.8928
            ...
            if (!Char.IsDead($.goon_at_yard9)) {
                ...
                if ($.goon_at_yard9_flag == 1) {
                    if ($.goon_at_yard9.locateOnFoot2D(374.9931, -311.8263, 1.0, 1.0, false)) {
                        $.goon_at_yard9.setObjRunToCoord(348.1611, -301.964)
                        $.goon_at_yard9_flag = 2
                    }
                }
                if ($.goon_at_yard9_flag == 2) {
                    if ($.goon_at_yard9.locateOnFoot2D(348.1611, -301.964, 1.0, 1.0, false)) {
                ...
                if ($.goon_at_yard9_flag == 3) {
                    if ($.goon_at_yard9.locateOnFoot2D(342.9392, -302.6671, 1.0, 1.0, false)) {
                        $.goon_at_yard9.setObjRunToCoord(327.6495, -317.261)
                        $.goon_at_yard9_flag = 4
                    }
                }
                if ($.goon_at_yard9_flag == 4) {
                    if ($.goon_at_yard9.locateOnFoot2D(327.6495, -317.261, 1.0, 1.0, false)) {
                        if ($.c_site_area_flag == 4) {
            ...
            if (!Char.IsDead($.goon_at_yard10)) {
                ...
                if ($.goon_at_yard10_flag == 4) {
                    if ($.goon_at_yard10.locateOnFoot2D(363.9329, -266.5335, 1.0, 1.0, false)) {
                        $.goon_at_yard10.setObjRunToCoord(361.977, -290.5143)
                        $.goon_at_yard10_flag = 5
                    }
                }
                if ($.goon_at_yard10_flag == 5) {
                    if ($.goon_at_yard10.locateOnFoot2D(361.977, -290.5143, 1.0, 1.0, false)) {
