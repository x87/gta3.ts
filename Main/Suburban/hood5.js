...
async function mission_start_hood5() {
  ...
  Text.PrintNow("HM5_A", 10000, 1);
  while ($.cs_time < 4403) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_B", 10000, 1);
  while ($.cs_time < 6287) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_C", 10000, 1);
  while ($.cs_time < 7888) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_D", 10000, 1);
  while ($.cs_time < 9678) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_E", 10000, 1);
  while ($.cs_time < 11491) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_F", 10000, 1);
  while ($.cs_time < 12974) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_G", 10000, 1);
  while ($.cs_time < 14952) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_H", 10000, 1);
  while ($.cs_time < 16068) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_I", 10000, 1);
  while ($.cs_time < 17531) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  Text.PrintNow("HM5_J", 10000, 1);
  while ($.cs_time < 19234) {
    await asyncWait(0);
    $.cs_time = Cutscene.GetTime();
  }
  ...
  while (!($.player.LocateAnyMeansChar2D($.goodie_hm5, 8.0, 8.0, 0 /* FALSE */))) {
    await asyncWait(0);
    if (Char.IsDead($.goodie_hm5)) {
      Text.PrintNow("HM5_4", 5000, 1);
  ...
  while (!(Audio.HasMissionAudioLoaded())) {
    ...
    if ($.player.LocateAnyMeansChar2D($.goodie_hm5, 8.0, 8.0, 0 /* FALSE */) && $.flag_goodie_message_hm5 == 1) {
      $.goodie_hm5.FollowPlayer($.player);
      $.radar_blip_goodie_hm5.Remove();
      $.flag_goodie_message_hm5 = 0;
    }
  ...
  $.baddie1_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie1_hm5.TurnToFaceCoord(-232.0, 253.0, -100.0);
  $.baddie1_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie2_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie2_hm5.TurnToFaceCoord(-232.0, 253.0, -100.0);
  $.baddie2_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie3_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie3_hm5.TurnToFaceCoord(-232.0, 253.0, -100.0);
  $.baddie3_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  $.baddie4_hm5 = Char.Create(13 /* PEDTYPE_GANG_HOOD */, ped`GANG_HOOD_B`, -222.5, 298.4, -100.0);
  ...
  $.baddie4_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie4_hm5.TurnToFaceCoord(-226.1, 280.8, -100.0);
  $.baddie4_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie5_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie5_hm5.TurnToFaceCoord(-226.1, 280.8, -100.0);
  $.baddie5_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie6_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie6_hm5.TurnToFaceCoord(-226.1, 280.8, -100.0);
  $.baddie6_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie7_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie7_hm5.TurnToFaceCoord(-226.1, 280.8, -100.0);
  $.baddie7_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie8_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie8_hm5.TurnToFaceCoord(-226.1, 280.8, -100.0);
  $.baddie8_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  ...
  $.baddie9_hm5.SetHeedThreats(1 /* TRUE */);
  $.baddie9_hm5.TurnToFaceCoord(-226.1, 280.8, -100.0);
  $.baddie9_hm5.SetOnlyDamagedByPlayer(1 /* TRUE */);
  while (!($.counter_no_of_baddies_dead_hm5 == 9)) {
    await asyncWait(0);
    if (Char.IsDead($.goodie_hm5)) {
      $.flag_goodie_hm5_dead_hm5 = 1;
    }
    if ($.player.IsInArea3D(-247.3, 333.9, 2.0, -209.5, 250.2, 15.0, 0 /* FALSE */)) {
    ...
    if ($.player.IsShootingInArea(-327.0, 72.0, -134.0, 350.0, 0 /* FALSE */)) {
      if ($.flag_baddie1_dead_hm5 == 0) {
...
async function mission_cleanup_hood5() {
  ...
  if ($.flag_baddie1_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie1_hm5))) {
      $.baddie1_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie2_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie2_hm5))) {
      $.baddie2_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie3_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie3_hm5))) {
      $.baddie3_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie4_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie4_hm5))) {
      $.baddie4_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie5_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie5_hm5))) {
      $.baddie5_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie6_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie6_hm5))) {
      $.baddie6_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie7_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie7_hm5))) {
      $.baddie7_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie8_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie8_hm5))) {
      $.baddie8_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  if ($.flag_baddie9_dead_hm5 == 0) {
    if (!(Char.IsDead($.baddie9_hm5))) {
      $.baddie9_hm5.SetOnlyDamagedByPlayer(0 /* FALSE */);
    }
  }
  Mission.Finish();
  return;
