...
async function mission_start_hood5() {
  ...
  //"Yo, Ice setyou was comin'. There are rules, bats only, no guns, no cars
  ...
  Audio.PlayMissionAudio();
  //"This is a battle for respect, you cool?"  //Change to print now when audio is there
  ...
  Audio.PlayMissionAudio();
  //"Lets go crack some blue skulls ( should be purple )"  //Change to print now when audio is there
  ...
  // Checks for baddie1
  //You were told to use a baseball bat only!"
  // Checks for baddie2
  // Checks for baddie3
  // Checks for baddie4
  // Checks for baddie5
