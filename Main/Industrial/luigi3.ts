...
async function mission_start_luigi3() {
  ...
  */
        ...
        if ($.player.locateInCar2D(937.9, -259.8, 3.0, 3.0, false /* FALSE */)) {
            if (
                $.player.isInModel(114 /* CAR_BUS */) ||
                $.player.isInModel(120 /* CAR_COACH */) ||
                $.player.isInModel(138 /* CAR_FLATBED */) ||
                $.player.isInModel(90 /* CAR_FIRETRUCK */) ||
                $.player.isInModel(83 /* CAR_LANDSTALKER */) ||
                $.player.isInModel(86 /* CAR_LINERUNNER */)
            ) {
                $.flag_camera_mode_lm3 = 1
            }
            if (
                $.player.isInModel(91 /* CAR_TRASHMASTER */) ||
                $.player.isInModel(96 /* CAR_PONY */) ||
                $.player.isInModel(97 /* CAR_MULE */) ||
                $.player.isInModel(99 /* CAR_AMBULANCE */) ||
                $.player.isInModel(106 /* CAR_MRWHOOPEE */) ||
                $.player.isInModel(110 /* CAR_ENFORCER */)
            ) {
                $.flag_camera_mode_lm3 = 1
            }
            if (
                $.player.isInModel(123 /* CAR_RUMPO */) ||
                $.player.isInModel(125 /* CAR_BELLYUP */) ||
                $.player.isInModel(126 /* CAR_MRWONGS */) ||
                $.player.isInModel(139 /* CAR_YANKEE */) ||
                $.player.isInModel(111 /* CAR_SECURICAR */)
            ) {
                $.flag_camera_mode_lm3 = 1
            }
        }
