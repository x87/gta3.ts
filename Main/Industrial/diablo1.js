...
async function mission_start_d1() {
  ...
  $.car1_d1.SetProofs(1 /* TRUE */, 1 /* TRUE */, 1 /* TRUE */, 0 /* FALSE */, 1 /* TRUE */);
  $.car1_d1.SetWatertight(1 /* TRUE */);
  $.car1_d1.SetStrong(1 /* TRUE */);
  $.car1_d1.SetUpsidedownNotDamaged(1 /* TRUE */);
  $.car2_d1 = Car.Create(98 /* CAR_CHEETAH */, 1053.3384, -859.3337, 13.7827);
  $.car2_d1.LockDoors(2 /* CARLOCK_LOCKED */);
  $.car2_d1.SetProofs(1 /* TRUE */, 1 /* TRUE */, 1 /* TRUE */, 0 /* FALSE */, 1 /* TRUE */);
  $.car2_d1.SetWatertight(1 /* TRUE */);
  $.car2_d1.SetStrong(1 /* TRUE */);
  $.car2_d1.SetUpsidedownNotDamaged(1 /* TRUE */);
  $.car3_d1 = Car.Create(98 /* CAR_CHEETAH */, 1058.6385, -859.2989, 13.7827);
  $.car3_d1.LockDoors(2 /* CARLOCK_LOCKED */);
  $.car3_d1.SetProofs(1 /* TRUE */, 1 /* TRUE */, 1 /* TRUE */, 0 /* FALSE */, 1 /* TRUE */);
  $.car3_d1.SetWatertight(1 /* TRUE */);
  $.car3_d1.SetStrong(1 /* TRUE */);
  $.car3_d1.SetUpsidedownNotDamaged(1 /* TRUE */);
  $.ped_car1_driver_d1 = Char.CreateInsideCar($.car1_d1, 4 /* PEDTYPE_CIVMALE */, ped`GANG_DIABLO_A`);
  $.ped_car2_driver_d1 = Char.CreateInsideCar($.car2_d1, 4 /* PEDTYPE_CIVMALE */, ped`GANG_DIABLO_B`);
  $.ped_car3_driver_d1 = Char.CreateInsideCar($.car3_d1, 4 /* PEDTYPE_CIVMALE */, ped`GANG_DIABLO_A`);
  $.ped_car1_driver_d1.SetCantBeDraggedOut(1 /* TRUE */);
  $.ped_car2_driver_d1.SetCantBeDraggedOut(1 /* TRUE */);
  $.ped_car3_driver_d1.SetCantBeDraggedOut(1 /* TRUE */);
  ...
  $.car1_d1.SetOnlyDamagedByPlayer(1 /* TRUE */);
  $.car2_d1.SetOnlyDamagedByPlayer(1 /* TRUE */);
  $.car3_d1.SetOnlyDamagedByPlayer(1 /* TRUE */);
  $.blip_chase_d1 = Blip.AddForCoord(1042.9772, -858.7398, 13.7827);
  Text.PrintNow(DIAB1_4, 5000, 1);
  while (!($.player.LocateStoppedInCar3D(1042.9772, -858.7398, 13.7827, 2.0, 2.0, 2.0, 1))) {
    await asyncWait(0);
    if ($.player.LocateStoppedOnFoot3D(1042.9772, -858.7398, 13.7827, 2.0, 2.0, 2.0, 1)) {
...
async function race_start() {
  $.car1_d1.SetOnlyDamagedByPlayer(0 /* FALSE */);
  $.car2_d1.SetOnlyDamagedByPlayer(0 /* FALSE */);
  $.car3_d1.SetOnlyDamagedByPlayer(0 /* FALSE */);
  if ($.timerc == 9) {
...
async function loop1() {
  ...
  if ($.player.LocateInCar3D($.player_x_d1, $.player_y_d1, $.player_z_d1, 6.0, 6.0, 6.0, 0)) {
    ++$.player_cpcounter;
    $.blip_chase_d1.Remove();
    $.second_blip.Remove();
  ...
  if (!(Car.IsDead($.car1_d1))) {
    ...
    if ($.car1_d1.Locate3D($.car1_stuck_x, $.car1_stuck_y, $.car1_stuck_z, 4.0, 4.0, 4.0, 0)) {
    ...
    if ($.car1_d1.Locate3D($.car1_x_d1, $.car1_y_d1, $.car1_z_d1, $.ai_car1_locate_size, $.ai_car1_locate_size, $.ai_car1_locate_size, 0)) {
      ++$.car1_cpcounter;
      if ($.car1_cpcounter == 1) {
        $.car1_x_d1 = $.cp3_x_d1;
        $.car1_y_d1 = $.cp3_y_d1;
  ...
  if (!(Car.IsDead($.car2_d1))) {
    ...
    if ($.car2_d1.Locate3D($.car2_stuck_x, $.car2_stuck_y, $.car2_stuck_z, 4.0, 4.0, 4.0, 0)) {
    ...
    if ($.car2_d1.Locate3D($.car2_x_d1, $.car2_y_d1, $.car2_z_d1, $.ai_car2_locate_size, $.ai_car2_locate_size, $.ai_car2_locate_size, 0)) {
      ++$.car2_cpcounter;
      if ($.car2_cpcounter == 1) {
        $.car2_x_d1 = $.cp3_x_d1;
        $.car2_y_d1 = $.cp3_y_d1;
  ...
  if (!(Car.IsDead($.car3_d1))) {
    ...
    if ($.car3_d1.Locate3D($.car3_stuck_x, $.car3_stuck_y, $.car3_stuck_z, 4.0, 4.0, 4.0, 0)) {
    ...
    if ($.car3_d1.Locate3D($.car3_x_d1, $.car3_y_d1, $.car3_z_d1, $.ai_car3_locate_size, $.ai_car3_locate_size, $.ai_car3_locate_size, 0)) {
      ++$.car3_cpcounter;
      if ($.car3_cpcounter == 1) {
        $.car3_x_d1 = $.cp3_x_d1;
        $.car3_y_d1 = $.cp3_y_d1;
  ...
  // SCM GOTO → loop1 (not lowered; manual jump required)
  throw new Error("unresolved GOTO loop1"); // fallback: would break linear control flow
  }
}
