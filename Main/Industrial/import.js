  ...
  if ($.player.IsPlaying()) {
    if (Streaming.IsCollisionInMemory(1 /* LEVEL_INDUSTRIAL */)) {
      if ($.player.IsInZone("REDLIGH")) {
        if ($.player.IsInArea3D(828.9, -283.8, 0.0, 894.2, -323.5, 26.0, 0 /* FALSE */)) {
          if ($.bonus_weapons_created == 0) {
            ...
            if ($.earned_free_armour == 1) {
              $.bonus_gun5 = Pickup.Create(bodyarmour, 14 /* PICKUP_ON_STREET_SLOW */, 868.8, -317.1, 10.0);
            }
            ...
            if ($.ind_copcar_kills > 9) {
              $.bonus_bribe1 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 877.6, -313.8, 8.5);
            }
            if ($.ind_copcar_kills > 19) {
              $.bonus_bribe2 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 875.6, -313.8, 8.5);
            }
            if ($.com_copcar_kills > 9) {
              $.bonus_bribe3 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 873.6, -313.8, 8.5);
            }
            if ($.com_copcar_kills > 19) {
              $.bonus_bribe4 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 871.6, -313.8, 8.5);
            }
            if ($.sub_copcar_kills > 9) {
              $.bonus_bribe5 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 869.6, -313.8, 8.5);
            }
            if ($.sub_copcar_kills > 19) {
              $.bonus_bribe6 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 867.6, -313.8, 8.5);
            }
            if ($.total_saved_peds > 34) {
              $.bonus_health = Pickup.Create(HEALTH, 14 /* PICKUP_ON_STREET_SLOW */, 878.9, -299.0, 8.2);
            }
            if ($.total_saved_peds > 69) {
              $.bonus_adrenaline = Pickup.Create(ADRENALINE, 14 /* PICKUP_ON_STREET_SLOW */, 876.9, -299.0, 8.2);
            }
    ...
    if (Streaming.IsCollisionInMemory(2 /* LEVEL_COMMERCIAL */)) {
      if ($.player.IsInZone("PARK")) {
        if ($.player.IsInArea3D(39.5, -443.8, 53.0, 167.5, -484.6, 15.0, 0 /* FALSE */)) {
          if ($.bonus_weapons_created == 0) {
            if ($.earned_free_pistol == 1) {
            ...
            if ($.earned_free_armour == 1) {
              $.bonus_gun5 = Pickup.Create(bodyarmour, 14 /* PICKUP_ON_STREET_SLOW */, 125.6, -477.9, 15.9);
            }
            if ($.earned_free_molotovs == 1) {
            ...
            if ($.ind_copcar_kills > 9) {
              $.bonus_bribe1 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 114.5, -458.0, 15.5);
            }
            if ($.ind_copcar_kills > 19) {
              $.bonus_bribe2 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 112.5, -458.0, 15.5);
            }
            if ($.com_copcar_kills > 9) {
              $.bonus_bribe3 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 110.5, -458.0, 15.5);
            }
            if ($.com_copcar_kills > 19) {
              $.bonus_bribe4 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 108.5, -458.0, 15.5);
            }
            if ($.sub_copcar_kills > 9) {
              $.bonus_bribe5 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 106.5, -458.0, 15.5);
            }
            if ($.sub_copcar_kills > 19) {
              $.bonus_bribe6 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, 104.5, -458.0, 15.5);
            }
            if ($.total_saved_peds > 34) {
              $.bonus_health = Pickup.Create(HEALTH, 14 /* PICKUP_ON_STREET_SLOW */, 94.6, -472.5, 15.5);
            }
            if ($.total_saved_peds > 69) {
              $.bonus_adrenaline = Pickup.Create(ADRENALINE, 14 /* PICKUP_ON_STREET_SLOW */, 92.6, -472.5, 15.5);
            }
            $.bonus_weapons_created = 1;
          }
        }
    ...
    if (Streaming.IsCollisionInMemory(3 /* LEVEL_SUBURBAN */)) {
      if ($.player.IsInZone("PROJECT")) {
        if ($.player.IsInArea3D(-595.8, -68.2, 10.0, -700.7, 3.1, 30.0, 0 /* FALSE */)) {
          if ($.bonus_weapons_created == 0) {
            if ($.earned_free_pistol == 1) {
            ...
            if ($.earned_free_armour == 1) {
              $.bonus_gun5 = Pickup.Create(bodyarmour, 14 /* PICKUP_ON_STREET_SLOW */, -642.5, -24.8, 18.8);
            }
            if ($.earned_free_molotovs == 1) {
            ...
            if ($.ind_copcar_kills > 9) {
              $.bonus_bribe1 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, -663.0, -28.0, 18.3);
            }
            if ($.ind_copcar_kills > 19) {
              $.bonus_bribe2 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, -665.0, -28.0, 18.3);
            }
            if ($.com_copcar_kills > 9) {
              $.bonus_bribe3 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, -667.0, -28.0, 18.3);
            }
            if ($.com_copcar_kills > 19) {
              $.bonus_bribe4 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, -669.0, -28.0, 18.3);
            }
            if ($.sub_copcar_kills > 9) {
              $.bonus_bribe5 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, -671.0, -28.0, 18.3);
            }
            if ($.sub_copcar_kills > 19) {
              $.bonus_bribe6 = Pickup.Create(BRIBE, 14 /* PICKUP_ON_STREET_SLOW */, -673.0, -28.0, 18.3);
            }
            if ($.total_saved_peds > 34) {
              $.bonus_health = Pickup.Create(HEALTH, 14 /* PICKUP_ON_STREET_SLOW */, -654.3, -21.7, 18.3);
            }
            if ($.total_saved_peds > 69) {
              $.bonus_adrenaline = Pickup.Create(ADRENALINE, 14 /* PICKUP_ON_STREET_SLOW */, -654.3, -19.7, 18.3);
            }
            $.bonus_weapons_created = 1;
          }
        }
...
async function import1_loop_inner() {
    ...
    if ($.player.IsInZone("PORT_E")) {
      if (!($.industrial_garage_slots_filled == 16)) {
        if ($.collect_all_cars1.HasSlotBeenFilled(1) && $.industrial_slot1 == 0) {
          ...
          $.securicar_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 13.582);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(2) && $.industrial_slot2 == 0) {
          $.industrial_garage_slots_filled++;
          $.moonbeam_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 13.385);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(3) && $.industrial_slot3 == 0) {
          $.industrial_garage_slots_filled++;
          $.coach_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 13.18);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(4) && $.industrial_slot4 == 0) {
          $.industrial_garage_slots_filled++;
          $.flatbed_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 12.972);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(5) && $.industrial_slot5 == 0) {
          $.industrial_garage_slots_filled++;
          $.linerunner_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 12.75);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(6) && $.industrial_slot6 == 0) {
          $.industrial_garage_slots_filled++;
          $.trashmaster_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 12.549);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(7) && $.industrial_slot7 == 0) {
          $.industrial_garage_slots_filled++;
          $.patriot_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 12.35);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(8) && $.industrial_slot8 == 0) {
          $.industrial_garage_slots_filled++;
          $.whoopee_score_off = Object.CreateNoOffset(line, 1496.036, -674.578, 12.131);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(9) && $.industrial_slot9 == 0) {
          $.industrial_garage_slots_filled++;
          $.blista_score_off = Object.CreateNoOffset(line, 1496.036, -675.459, 13.582);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(10) && $.industrial_slot10 == 0) {
          $.industrial_garage_slots_filled++;
          $.mule_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 13.361);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(11) && $.industrial_slot11 == 0) {
          $.industrial_garage_slots_filled++;
          $.yankee_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 13.151);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(12) && $.industrial_slot12 == 0) {
          $.industrial_garage_slots_filled++;
          $.bobcat_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 12.966);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(13) && $.industrial_slot13 == 0) {
          $.industrial_garage_slots_filled++;
          $.dodo_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 12.757);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(14) && $.industrial_slot14 == 0) {
          $.industrial_garage_slots_filled++;
          $.bus_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 12.52);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(15) && $.industrial_slot15 == 0) {
          $.industrial_garage_slots_filled++;
          $.rumpo_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 12.322);
        ...
        if ($.collect_all_cars1.HasSlotBeenFilled(16) && $.industrial_slot16 == 0) {
          $.industrial_garage_slots_filled++;
          $.pony_score_off = Object.CreateNoOffset(line, 1496.036, -675.474, 12.131);
        ...
        await asyncWait(0);
        if ($.player.IsPlaying()) {
          if ($.player.IsInArea2D(1486.9, -686.2, 1524.1, -666.8, 0 /* FALSE */)) {
            if ($.create_car_pickups_industrial == 0) {
              $.securicar_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 1, 1501.0, -683.0, 12.1);
              $.moonbeam_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 2, 1505.0, -683.0, 12.1);
              $.coach_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 3, 1509.0, -683.0, 12.1);
              $.flatbed_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 4, 1513.0, -683.0, 12.1);
              $.linerunner_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 5, 1517.0, -683.0, 12.1);
              $.trashmaster_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 6, 1521.0, -683.0, 12.1);
              $.patriot_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 7, 1521.0, -680.0, 12.1);
              $.whoopee_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 8, 1521.0, -677.0, 12.1);
              $.blista_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 9, 1521.0, -674.0, 12.1);
              $.mule_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 10, 1521.0, -671.0, 12.1);
              $.yankee_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 11, 1521.0, -668.0, 12.1);
              $.bobcat_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 12, 1517.0, -668.0, 12.1);
              $.dodo_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 13, 1513.0, -668.0, 12.1);
              $.bus_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 14, 1509.0, -668.0, 12.1);
              $.rumpo_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 15, 1505.0, -668.0, 12.1);
              $.pony_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 16, 1501.0, -668.0, 12.1);
            ...
            if ($.import_car_been_created_before == 0) {
              ...
              // fallback if label was not emitted as async function: no-op continues linearly
              if ($.player.IsPlaying()) {
                while (!($.player.IsInArea2D(1486.9, -686.2, 1495.5, -674.1, 0 /* FALSE */))) {
                  await asyncWait(0);
                  if ($.player.IsPlaying()) {
                  }
                }
            ...
            if ($.create_car_pickups_industrial == 1) {
              ...
              if ($.import_car_been_created_before == 1) {
                if (!(Car.IsDead($.imported_car))) {
                  if ($.imported_car.IsInArea2D(1496.8, -686.2, 1523.3, -666.8, 0 /* FALSE */)) {
                    $.imported_car.Delete();
                  }
                  else {
  ...
  // SCM GOTO → import1_loop_inner (not lowered; manual jump required)
  throw new Error("unresolved GOTO import1_loop_inner"); // fallback: would break linear control flow
  }
}
...
async function military_crane_loop_inner() {
  await asyncWait(500);
  if ($.player.IsPlaying()) {
    if ($.player.IsInArea2D(1548.1, -745.5, 1583.0, -675.1, 0 /* FALSE */)) {
      if (Crane.HasMilitaryCollectedAllCars()) {
        ...
        if (!(World.IsAreaOccupied(1565.9, -706.7, 9.0, 1577.2, -686.3, 20.0, 0 /* FALSE */, 1 /* TRUE */, 0 /* FALSE */, 0 /* FALSE */, 0 /* FALSE */))) {
          if ($.create_military_pickups == 0 && $.military_car_been_created_before == 0) {
            $.copcar_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 39, 1571.0, -687.0, 11.8);
            $.swatvan_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 35, 1571.0, -691.0, 11.8);
            $.fbi_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 36, 1571.0, -694.0, 11.8);
            $.tank_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 37, 1571.0, -697.0, 11.8);
            $.barracks_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 38, 1571.0, -700.0, 11.8);
            $.ambulance_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 34, 1571.0, -703.0, 11.8);
            $.firetruck_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 33, 1571.0, -706.0, 11.8);
      ...
      if ($.player.IsPlaying()) {
        if ($.military_car_been_created_before == 1) {
          if (Car.IsDead($.military_car)) {
            ...
            if (!($.military_car.IsInArea2D(1668.6, -685.7, 1548.1, -745.5, 0 /* FALSE */))) {
...
async function import2_loop_inner() {
    ...
    if ($.player.IsInZone("BIG_DAM")) {
      if (!($.suburban_garage_slots_filled == 16)) {
        if ($.collect_all_cars2.HasSlotBeenFilled(1) && $.suburban_slot1 == 0) {
          ...
          $.sentinet_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 60.529);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(2) && $.suburban_slot2 == 0) {
          $.suburban_garage_slots_filled++;
          $.cheetah_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 60.332);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(3) && $.suburban_slot3 == 0) {
          $.suburban_garage_slots_filled++;
          $.banshee_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 60.127);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(4) && $.suburban_slot4 == 0) {
          $.suburban_garage_slots_filled++;
          $.idaho_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 59.919);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(5) && $.suburban_slot5 == 0) {
          $.suburban_garage_slots_filled++;
          $.infernus_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 59.697);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(6) && $.suburban_slot6 == 0) {
          $.suburban_garage_slots_filled++;
          $.taxi_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 59.497);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(7) && $.suburban_slot7 == 0) {
          $.suburban_garage_slots_filled++;
          $.kuruma_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 59.298);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(8) && $.suburban_slot8 == 0) {
          $.suburban_garage_slots_filled++;
          $.stretch_score_off = Object.CreateNoOffset(line, -1106.161, 151.191, 59.079);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(9) && $.suburban_slot9 == 0) {
          $.suburban_garage_slots_filled++;
          $.perennial_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 60.529);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(10) && $.suburban_slot10 == 0) {
          $.suburban_garage_slots_filled++;
          $.stinger_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 60.309);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(11) && $.suburban_slot11 == 0) {
          $.suburban_garage_slots_filled++;
          $.manana_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 60.098);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(12) && $.suburban_slot12 == 0) {
          $.suburban_garage_slots_filled++;
          $.landstalker_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 59.919);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(13) && $.suburban_slot13 == 0) {
          $.suburban_garage_slots_filled++;
          $.stallion_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 59.697);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(14) && $.suburban_slot14 == 0) {
          $.suburban_garage_slots_filled++;
          $.injection_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 59.497);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(15) && $.suburban_slot15 == 0) {
          $.suburban_garage_slots_filled++;
          $.cabbie_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 59.298);
        ...
        if ($.collect_all_cars2.HasSlotBeenFilled(16) && $.suburban_slot16 == 0) {
          $.suburban_garage_slots_filled++;
          $.esperanto_score_off = Object.CreateNoOffset(line, -1107.042, 151.191, 59.079);
        ...
        await asyncWait(0);
        if ($.player.IsPlaying()) {
          if ($.player.IsInArea2D(-1117.4, 158.1, -1098.0, 121.5, 0 /* FALSE */)) {
            if ($.create_car_pickups_suburban == 0) {
              $.sentinet_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 17, -1115.0, 145.5, 59.0);
              $.cheetah_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 18, -1115.0, 142.0, 59.0);
              $.banshee_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 19, -1115.0, 138.5, 59.0);
              $.idaho_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 20, -1115.0, 135.0, 59.0);
              $.infernus_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 21, -1115.0, 131.5, 59.0);
              $.taxi_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 22, -1115.0, 128.0, 59.0);
              $.kuruma_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 23, -1112.0, 128.0, 59.0);
              $.stretch_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 24, -1109.0, 128.0, 59.0);
              $.perennial_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 25, -1106.0, 128.0, 59.0);
              $.stinger_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 26, -1103.0, 128.0, 59.0);
              $.manana_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 27, -1100.0, 128.0, 59.0);
              $.landstalker_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 28, -1100.0, 131.5, 59.0);
              $.stallion_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 29, -1100.0, 135.0, 59.0);
              $.injection_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 30, -1100.0, 138.5, 59.0);
              $.cabbie_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 31, -1100.0, 142.0, 59.0);
              $.esperanto_pickup = Pickup.CreateWithAmmo(bonus, 3 /* PICKUP_ONCE */, 32, -1100.0, 145.5, 59.0);
              await asyncWait(1000);
            ...
            if ($.import_car_been_created_before2 == 0) {
              ...
              // fallback if label was not emitted as async function: no-op continues linearly
              if ($.player.IsPlaying()) {
                while (!($.player.IsInArea2D(-1117.4, 158.1, -1105.0, 150.9, 0 /* FALSE */))) {
                  await asyncWait(0);
                  if ($.player.IsPlaying()) {
                  }
                }
            ...
            if ($.create_car_pickups_suburban == 1) {
              ...
              if ($.import_car_been_created_before2 == 1) {
                if (!(Car.IsDead($.imported_car2))) {
                  if ($.imported_car2.IsInArea2D(-1117.4, 149.8, -1098.0, 121.5, 0 /* FALSE */)) {
  ...
  // SCM GOTO → import2_loop_inner (not lowered; manual jump required)
  throw new Error("unresolved GOTO import2_loop_inner"); // fallback: would break linear control flow
  }
}
