...
async function mission_start_joey4() {
  ...
  while (!($.joeys_garage_door2.slide($.joeydoor2_X, $.joeydoor2_Y, $.joeydoor2_Z, 0.1, 0.1, 100.0, false /* FALSE */)) || !($.joeys_garage_door3.slide($.joeydoor3_X, $.joeydoor3_Y, $.joeydoor3_Z, 0.1, 0.1, 100.0, false /* FALSE */))) {
    await asyncWait(0);
