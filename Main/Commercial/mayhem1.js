...
async function mission_start_mayhem() {
  ...
  while ($.counter_4x4_pickups < 20) {
    ...
    if ($.flag_blip_1 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_1, $.y_1, $.z_1, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_2 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_2, $.y_2, $.z_2, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_3 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_3, $.y_3, $.z_3, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_4 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_4, $.y_4, $.z_4, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_5 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_5, $.y_5, $.z_5, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_6 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_6, $.y_6, $.z_6, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_7 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_7, $.y_7, $.z_7, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_8 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_8, $.y_8, $.z_8, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_9 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_9, $.y_9, $.z_9, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_10 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_10, $.y_10, $.z_10, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_11 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_11, $.y_11, $.z_11, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_12 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_12, $.y_12, $.z_12, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_13 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_13, $.y_13, $.z_13, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_14 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_14, $.y_14, $.z_14, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_15 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_15, $.y_15, $.z_15, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_16 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_16, $.y_16, $.z_16, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_17 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_17, $.y_17, $.z_17, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_18 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_18, $.y_18, $.z_18, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_19 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_19, $.y_19, $.z_19, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
    ...
    if ($.flag_blip_20 == 0) {
      ...
      if ($.player.LocateInCar3D($.x_20, $.y_20, $.z_20, 2.0, 2.0, 2.0, 0 /* false */)) {
        ++$.counter_4x4_pickups;
