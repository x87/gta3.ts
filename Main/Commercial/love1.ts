...
async function mission_start_love1() {
  ...
  */
  ...
  //"Get a columbian gang car, you'll need it to infiltrate the hideout."
  ...
  //"Rescue the Old Japanese Gentleman."
  ...
  //"Walk towards the garages, the Old Oriental Gentleman is in one of them."
  // Checks for garage1
  // Checks for garage2
  // Checks for garage3
  // Checks for garage4
  ...
  //"You have left the Old Oriental Gentleman behind go and get him!"
  while (!($.ojg_love1.locateStoppedAnyMeans2D(49.0, -1550.0, 3.0, 4.0, $.blob_flag))) {
    ...
    if ($.flag_kill_player_love1 == 1) {
      ...
      // Checks for garage2
      if ($.player.isInAreaOnFoot3D(63.01, -317.50, 13.0, 69.28, -321.73, 20.0, false /* FALSE */)) {
