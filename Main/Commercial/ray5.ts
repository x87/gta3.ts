...
async function mission_start_ray5() {
  ...
  */
  ...
  //"You messed up! My ass is on the line and you can't hurt a god damned fly."
...
async function amb_generator() {
  ...
  //---amb goto penultimate waypoint
  //----amb goto final destination
  //---ambulance was decoy!!
  //---player taken the bait ---police close in
  ...
  //ambulance_health = ambulance_health / 10
  //ambulance_health = ambulance_health * 5
  //---ambulance damaged enough to force bailout
  ...
  //ambulance_health = ambulance_health / 10
  //ambulance_health = ambulance_health * 5
  //---ambulance has reached destination without bailout -mission failed
  //OR IS_CAR_STUCK_ON_ROOF ambulance_rc5
  //---ambulance was decoy!!
  //---player taken the bait ---police close in
...
async function injured_cop_bailout() {
  ...
  */
  ...
  //bullets won't get through that armoured plaster!!
  //That Plaster's flame retardent!!
  //witness has drowned!!
