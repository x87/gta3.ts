...
export async function main() {
  ...
  Path.SwitchRoadsOff(-1052.6693, -78.0430, 50.0, -988.0153, -67.1608, 30.0); // warehouse in Suburbia
  Path.SwitchPedRoadsOff(-1052.6693, -78.0430, 50.0, -988.0153, -67.1608, 30.0); // warehouse in Suburbia
  ...
  Path.SwitchRoadsOff(-1367.7690, -731.4872, 20.0, -743.1906, -410.1961, 5.0); // Airport
  ...
  // *****************************************CREATE PLAYER***************************************
  $.player = Player.Create(0, 811.90, -939.95, 35.8); //8Ball mission
  $.player.setHeading(180.0);
